...
/**
 * Uploads a folder by path to the server
 * @param folderPath Absolute path to the folder to upload
 * @returns Promise with the upload response
 */
export const uploadFolder = async (folderPath: string): Promise<DocActionResponse> => {
  const response = await axiosInstance.post('/documents/upload-folder', {
